...
median(budburst$JulianDay)
IQR(budburst$JulianDay)


median_value1 <- mode(budburst[budburst$Period == 1, "JulianDay"], na.rm = TRUE)
median_value2 <- mode(budburst[budburst$Period == 2, "JulianDay"], na.rm = TRUE)

iqr1 <- IQR(budburst[budburst$Period == 1, "JulianDay"], na.rm = TRUE)
iqr2 <- IQR(budburst[budburst$Period == 2, "JulianDay"], na.rm = TRUE)
...
tab_model(mixed_model, digits= 4)
