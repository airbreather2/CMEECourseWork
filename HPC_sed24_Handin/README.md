...
The simulations are executed on an **HPC cluster**, with results stored and analyzed using **R**.
...
| `*.png` files | Saved plots from analysis scripts. |

---

## **Core Functions**
These functions are **essential for running simulations** and analyzing species dynamics.
...
### **Individual-Based Neutral Theory Simulation**
| Function | Description |
|----------|------------|
